...
class __TwigTemplate_e64ab365e3baa5481a32d1fee83a9505 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 4
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["field"]) || array_key_exists("field", $context) ? $context["field"] : (function () { throw new RuntimeError('Variable "field" does not exist.', 4, $this->source); })()), "customOptions", [], "any", false, false, false, 4), "get", ["showSample"], "method", false, false, false, 4)) {
            // line 5
            ...
            echo "; ";
            echo ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["field"]) || array_key_exists("field", $context) ? $context["field"] : (function () { throw new RuntimeError('Variable "field" does not exist.', 5, $this->source); })()), "customOptions", [], "any", false, false, false, 5), "get", ["showValue"], "method", false, false, false, 5)) ? ("margin-right: 5px;") : (""));
            echo "\" title=\"";
...
";
        ...
        // line 7
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["field"]) || array_key_exists("field", $context) ? $context["field"] : (function () { throw new RuntimeError('Variable "field" does not exist.', 7, $this->source); })()), "customOptions", [], "any", false, false, false, 7), "get", ["showValue"], "method", false, false, false, 7)) {
            // line 8
            echo "    ";
...
{% endif %}
", "@EasyAdmin/crud/field/color.html.twig", "/Users/liamcr/Documents/portfolio-v3/vendor/easycorp/easyadmin-bundle/src/Resources/views/crud/field/color.html.twig");
    }
}
